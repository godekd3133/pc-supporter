...
const IMPACTS_BY_CATEGORY: Record<string, Record<string, ImpactDefinition>> = {
  ...
  motherboard: {
    ...
    pcieX16Slots: { kind: "compatibility", label: "GPU·PCIe 장착", summary: "그래픽카드·PCIe 어댑터 장착 폭과 메인보드 슬롯을 다시 판정합니다.", ruleIds: ["gpu-motherboard-pcie", "accessory-pcie-slot-capacity", "accessory-pcie-slot-clearance"] },
    pcieX8Slots: { kind: "compatibility", label: "GPU·PCIe 장착", summary: "그래픽카드·PCIe 어댑터 장착 폭과 메인보드 슬롯을 다시 판정합니다.", ruleIds: ["gpu-motherboard-pcie", "accessory-pcie-slot-capacity", "accessory-pcie-slot-clearance"] },
    pcieX4Slots: { kind: "compatibility", label: "PCIe 어댑터 장착", summary: "M.2 PCIe 어댑터의 요구 폭과 메인보드 보조 슬롯을 다시 판정합니다.", ruleIds: ["accessory-pcie-slot-capacity", "accessory-pcie-slot-clearance"] },
    pcieX1Slots: { kind: "compatibility", label: "PCIe 어댑터 장착", summary: "M.2 PCIe 어댑터의 요구 폭과 메인보드 보조 슬롯을 다시 판정합니다.", ruleIds: ["accessory-pcie-slot-capacity", "accessory-pcie-slot-clearance"] },
