...
function shareHealthLabel(status: AlternativeComparisonShareHealthStatus) {
  return status === "checking" ? "상태 확인 중" : status === "active" ? "사용 가능" : status === "expired" ? "만료됨" : status === "revoked" ? "취소되었거나 없음" : "상태 불러오기 실패";
}
