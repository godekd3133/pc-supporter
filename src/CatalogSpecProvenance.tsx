...
function catalogSpecSourceCheckLabel(check: PhysicalSourceCheck | undefined) {
  ...
  return physicalSourceCheckNeedsReview(check, true) ? "정보 재확인 필요" : "원문·모델 확인됨";
}
