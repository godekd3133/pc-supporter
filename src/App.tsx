...
const RULE_GUIDES: Record<string, string> = {
  ...
  "m2-interface": "메인보드가 선택한 SATA 방식 M.2 SSD를 지원하는지 알 수 없어요.",
  "m2-pcie-generation": "SSD와 메인보드의 PCIe 세대가 다르면 최대 속도가 달라질 수 있어요.",
  "m2-slot-topology": "여러 SSD를 사용할 때 슬롯별 연결 정보를 알 수 없어요.",
  "m2-slot-selection": "SSD 수량과 선택한 M.2 슬롯 수가 맞지 않아요.",
  "m2-slot-routing": "선택한 SSD와 M.2 슬롯의 연결 방식이 맞지 않아요.",
  "m2-slot-sharing": "일부 M.2 슬롯은 GPU 또는 SATA 저장장치와 연결을 나눠 써요.",
  "m2-pcie-lane-sharing": "M.2 SSD와 GPU가 PCIe 대역폭을 나눠 쓸 수 있어요.",
  "sata-ports": "SATA SSD와 HDD를 연결할 포트가 부족해요.",
  "hdd-interface": "선택한 HDD의 연결 방식이 메인보드와 맞지 않아요.",
  "case-hdd-bays": "HDD 수량이 케이스의 장착 베이보다 많아요.",
  "case-motherboard-form-factor": "메인보드 크기가 케이스와 맞지 않아요.",
  "case-fan-headers": "케이스 팬을 연결할 메인보드 단자가 부족해요. 팬 허브가 필요할 수 있어요.",
  "case-rgb-headers": "케이스와 메인보드의 RGB 연결 규격이 맞지 않아요.",
  "case-rgb-voltage": "RGB 5V와 12V는 서로 연결할 수 없어요.",
  "cpu-cooler-socket": "CPU와 쿨러의 소켓 규격이 맞지 않아요.",
  "cpu-cooler-capacity": "CPU 전력에 비해 쿨러의 냉각 용량이 부족할 수 있어요.",
  "case-cooler-height": "쿨러 높이가 케이스 허용 높이보다 높아요.",
  "case-radiator-support": "수랭 쿨러 라디에이터 크기가 케이스와 맞지 않아요.",
  "display-output": "그래픽카드가 없고 CPU 내장 그래픽도 사용할 수 없어요.",
  ...
  "gpu-psu-cable-topology": "파워 케이블 연결 방식이 그래픽카드 요구와 맞지 않을 수 있어요.",
  "psu-case-length": "파워서플라이가 케이스 안에 들어가지 않을 수 있어요.",
  "psu-case-form-factor": "파워서플라이 크기가 케이스와 맞지 않아요.",
  "psu-data-quality": "파워서플라이의 정격 출력 정보가 없어 호환 여부를 알 수 없어요."
};
