...
const statusDescription = displayStatus === "incompatible"
  ...
  : displayStatus === "needs_review"
    ...
    : result.warningCount > 0 ? `구매 전에 살펴볼 항목이 ${result.warningCount}개 있어요.` : "확인된 정보 기준으로 사용할 수 있어요.";
...
return (
  <div className="result-page">
    <div className="mobile-result-toolbar"><button className="mobile-result-back" type="button" onClick={onBack} aria-label="홈으로"><FiArrowLeft /></button><div><strong>검사 결과</strong></div><button className="mobile-result-share" type="button" onClick={onCopyResultLink} aria-label="결과 링크 복사"><FiShare2 /></button></div>
