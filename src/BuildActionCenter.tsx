...
function actionButtonText(action: BuildAction) {
  return action.ruleId ? "finding 보기" : action.targetId === "gpu-fit-summary-panel" ? "GPU FIT 보기" : action.targetId === "build-resource-summary" ? "전력·냉각 보기" : action.targetId === "data-health-panel" ? "데이터 보기" : action.targetId === "purchase-list-panel" ? "구매 목록 보기" : action.targetId === "repair-plan-panel" ? "수리 플랜 보기" : action.targetId === "build-connectivity-panel" ? "연결 자원 보기" : "체크리스트 보기";
}
