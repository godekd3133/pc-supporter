...
function upgradeBundleExpansionText(evidence: UpgradeBundleRecommendation["expansionEvidence"], formatExpansionText: UpgradeBundlePanelProps["upgradeExpansionText"]) {
  if (!evidence) return "확장 정보가 부족해 비교할 수 없어요.";
